...
class _MyHomePageState extends State<MyHomePage> {
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: productWidget(
                              "right", "sofa1", "LOVE SET SOFA", "\$529.0", 2),
                        )
                      ],
                    ),
                    Row(
                      children: [
                        ...
                        Container(
                          width: MediaQuery.of(context).size.width * 0.5 - 15,
                          child: productWidget(
                              "left", "chair2", "RAYNER CHAIR", "\$59.0", 2),
                        )
                      ],
                    ),
                  ],
  ...
  Container productWidget(String side, String img, String name, String price,
  ...
  void selectCatagory(String title) {
